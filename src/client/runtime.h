...
namespace newscl {
  ...
  SocketIOClient* GetConnection2(const std::string &ip = ""); 
  SocketIOClient* GetFinishConnection2(const std::string &ip = ""); 
  

  SocketIOClient* GetConnection(int no = 1, const std::string &ip = ""); 
  SocketIOClient* GetFinishConnection(int no = 1, const std::string &ip = ""); 

//  SocketIOClient* GetNonBlockingConnection2(int no, const std::string kCNHost = "");
